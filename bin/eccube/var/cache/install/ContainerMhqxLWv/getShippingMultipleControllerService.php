...
class getShippingMultipleControllerService extends Eccube_KernelInstallContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.o0xIsSV'] ?? $container->load('get_ServiceLocator_O0xIsSVService'))->withContext('Eccube\\Controller\\ShippingMultipleController', $container));
