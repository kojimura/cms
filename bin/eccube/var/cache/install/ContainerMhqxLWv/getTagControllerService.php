...
class getTagControllerService extends Eccube_KernelInstallContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.1yawm5B'] ?? $container->load('get_ServiceLocator_1yawm5BService'))->withContext('Eccube\\Controller\\Admin\\Product\\TagController', $container));
