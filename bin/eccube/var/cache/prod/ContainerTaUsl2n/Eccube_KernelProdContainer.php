...
class Eccube_KernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $h = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/src/Eccube/Entity')]);
        $h->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Coupon42/Entity')]);
        $i->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/MailMagazine42/Entity')]);
        $j->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $k = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/ProductReview42/Entity')]);
        $k->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $l = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Recommend42/Entity')]);
        $l->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $m = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct42/Entity')]);
        $m->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $n = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Securitychecker42/Entity')]);
        $n->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $o = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/SiteKit42/Entity')]);
        $o->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));

        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/src/Eccube/Entity')]), 'Eccube\\Entity');
        $f->addDriver($h, 'Eccube\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Customize/Entity')]), 'Customize\\Entity');
        $f->addDriver($i, 'Plugin\\Coupon42\\Entity');
        $f->addDriver($j, 'Plugin\\MailMagazine42\\Entity');
        $f->addDriver($k, 'Plugin\\ProductReview42\\Entity');
        $f->addDriver($l, 'Plugin\\Recommend42\\Entity');
        $f->addDriver($m, 'Plugin\\RelatedProduct42\\Entity');
        $f->addDriver($n, 'Plugin\\Securitychecker42\\Entity');
        $f->addDriver($o, 'Plugin\\SiteKit42\\Entity');
    ...
    protected function getSecurity_Firewall_MapService()
    {
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.admin' => ($this->privates['.security.request_matcher.bqdhKrt'] ?? ($this->privates['.security.request_matcher.bqdhKrt'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')));
